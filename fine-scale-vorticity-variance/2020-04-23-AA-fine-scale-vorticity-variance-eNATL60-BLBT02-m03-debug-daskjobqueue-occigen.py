...
cluster = SLURMCluster(cores=28,name='make_profiles',walltime='01:30:00',job_extra=['--constraint=HSW24','--exclusive','--nodes=1'],memory='120GB') 
cluster.scale(240)
cluster
...
get_ipython().system(u'squeue -u albert7a')
